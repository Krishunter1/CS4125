...
public class UserMenu extends Frame {
    ...
    private JTable 	currentBookings;
    ...
    void displayFrame() {
        ...
        currentBookings.setAlignmentX(Component.CENTER_ALIGNMENT);
        currentBookings.setAlignmentY(Component.CENTER_ALIGNMENT);
